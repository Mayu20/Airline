...
<body background="images\As.png">
   ...
   // $passenger=$_POST['passenger'];
	$result = mysqli_query($conn, "SELECT * FROM flight,addfl,seat1 WHERE addfl.dept ='$dept'
     addfl.froml='$from'  addfl.tol='$to'  AND addfl.id=seat1.fno And seat1.isAvailbale=1");
            ...
            <?php
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $row["isAvailbale"] ?></td>
