...
$result = mysqli_query($conn, "SELECT * FROM flight,addfl,seat WHERE addfl.dept =flight.dept AND addfl.froml=flight.from AND addfl.tol=flight.to AND addfl.id=seat.id And seat.isAvailbale=1");
//$_SESSION["passenger"] = $_POST["passenger"]; //session var set
...
<body background="images\As.png">
    <div class="w3-topnav">
        <div class="w3-bar w3-theme-d2 w3-left-align">
            ...
            <a href="special.html" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Add Admin</a>
            <div class="w3-dropdown-hover w3-hide-small">
                <button class="w3-button" title="Notifications">Manage Flight<i class="fa fa-caret-down"></i></button>
                <div class="w3-dropdown-content w3-card-4 w3-bar-block">
                    <a href="contact.html" class="w3-bar-item w3-button">Add Flight</a>
                    <a href="route.html" class="w3-bar-item w3-button">Delete Flight </a>
                    <a href="#" class="w3-bar-item w3-button">Update Flight</a>
                </div>
            </div>
            <div class="w3-dropdown-hover w3-hide-small">
                <button class="w3-button" title="Notifications">Manage Customer<i class="fa fa-caret-down"></i></button>
                <div class="w3-dropdown-content w3-card-4 w3-bar-block">
                    <a href="contact.html" class="w3-bar-item w3-button">view Customer</a>
                    <a href="route.html" class="w3-bar-item w3-button">list of customer </a>

                </div>
            </div>

            <a href="Airline1.html" class="w3-bar-item w3-button w3-hide-small w3-hover-white">My Account</a>
