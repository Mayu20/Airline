...
<body background="images\bs.jpg">
  ...
  <h2 style="color:black">
    <marquee behaviour="scroll;direction:right; ">Stay Tuned For More Update.....!!!!</marquee>
  </h2>
  <div class="mySlides w3-display-container w3-center">
    <img src="images\on.jpg" style="width:100%">
    <div class="w3-display-topmiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
      <p><b><i style="font-size:larger"><u style="color:brown;"> Book Ticket Now...!!</u> <br>and make your journey Fast
            and Safe...!!!</i></b></p>
    </div>
